        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          <div className="text-center max-w-3xl mx-auto mb-8">
            ...
            <p className="text-zinc-400">
              Discover and deploy pre-built AI agents, tools, workflows, and datasets
            ...
            >
              <div className="p-6">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    <h3 className="text-lg font-medium text-zinc-100">Research Assistant</h3>
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  <span className="px-2 py-1 text-xs bg-zinc-800 text-zinc-400 rounded-full">Python</span>
                  <span className="px-2 py-1 text-xs bg-zinc-800 text-zinc-400 rounded-full">Research</span>
                  <span className="px-2 py-1 text-xs bg-zinc-800 text-zinc-400 rounded-full">Analysis</span>
                </div>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-zinc-800">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-1 text-zinc-400">
                      <Icon icon="heroicons:arrow-down-circle" className="w-4 h-4" />
                      <span>2.4k</span>
                    </div>
                  </div>
