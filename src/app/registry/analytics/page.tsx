      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-zinc-900 rounded-xl border border-zinc-800 p-6">
            <h2 className="text-lg font-medium text-zinc-100 mb-6">Downloads Trend</h2>
            <div className="h-80">
          ...
          {/* Top Components */}
          <div className="bg-zinc-900 rounded-xl border border-zinc-800 p-6">
            <h2 className="text-lg font-medium text-zinc-100 mb-6">Top Components</h2>
            <div className="h-80">
              <ResponsiveContainer width="100%" height="100%">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-zinc-900 rounded-xl border border-zinc-800 overflow-hidden">
            <div className="p-6 border-b border-zinc-800">
              <h2 className="text-lg font-medium text-zinc-100">Component Performance</h2>
            </div>
            <table className="w-full">
              <thead>
                <tr className="border-b border-zinc-800">
                  <th className="text-left py-4 px-6 text-xs font-medium text-zinc-400">Component</th>
                  ...
                  <th className="text-left py-4 px-6 text-xs font-medium text-zinc-400">Revenue</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-zinc-800">
                {mockData.topComponents.map((component) => (
                  <tr key={component.name} className="hover:bg-zinc-800/50">
                    ...
                    <td className="py-4 px-6 text-zinc-400">{component.downloads}</td>
                    <td className="py-4 px-6">
                      <div className="flex items-center gap-1">
                        <Icon icon="heroicons:star" className="w-4 h-4 text-yellow-500" />
                        <span className="text-zinc-400">{component.rating}</span>
                      </div>
                    </td>
          ...
          {/* Recent Activity */}
          <div className="bg-zinc-900 rounded-xl border border-zinc-800 p-6">
            <h2 className="text-lg font-medium text-zinc-100 mb-6">Recent Activity</h2>
            <div className="space-y-4">
              {[
                ...
                <div key={index} className="flex items-start gap-4">
                  <div className="p-2 rounded-lg bg-gradient-to-r from-green-500/10 to-blue-500/10">
                    <Icon icon={activity.icon} className="w-5 h-5 text-green-500" />
                  </div>
                  <div>
                    <p className="text-zinc-300">{activity.action}</p>
                    <p className="text-sm text-zinc-500">{activity.component}</p>
